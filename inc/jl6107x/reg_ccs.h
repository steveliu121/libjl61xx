...
#define CCS_CHIP_INT_OFFSET_RSVD0                                                                                  (11)
#define CCS_CHIP_INT_OFFSET_RSVD0_WIDTH                                                                            (21)
...
#define CCS_CHIP_INT_OFFSET_PHY_0_INT                                                                               (4)
#define CCS_CHIP_INT_OFFSET_PHY_0_INT_WIDTH                                                                         (1)
#define CCS_CHIP_INT_OFFSET_PHY_1_INT                                                                               (5)
#define CCS_CHIP_INT_OFFSET_PHY_1_INT_WIDTH                                                                         (1)
#define CCS_CHIP_INT_OFFSET_PHY_2_INT                                                                               (6)
#define CCS_CHIP_INT_OFFSET_PHY_2_INT_WIDTH                                                                         (1)
#define CCS_CHIP_INT_OFFSET_PHY_3_INT                                                                               (7)
#define CCS_CHIP_INT_OFFSET_PHY_3_INT_WIDTH                                                                         (1)
#define CCS_CHIP_INT_OFFSET_PHY_4_INT                                                                               (8)
#define CCS_CHIP_INT_OFFSET_PHY_4_INT_WIDTH                                                                         (1)
#define CCS_CHIP_INT_OFFSET_SDS_0_INT                                                                               (9)
#define CCS_CHIP_INT_OFFSET_SDS_0_INT_WIDTH                                                                         (1)
#define CCS_CHIP_INT_OFFSET_SDS_1_INT                                                                              (10)
#define CCS_CHIP_INT_OFFSET_SDS_1_INT_WIDTH                                                                         (1)
typedef union CCS_CHIP_INT_u {
    struct __attribute__ ((packed)) {
        ...
        jl_uint32 phy_0_int:CCS_CHIP_INT_OFFSET_PHY_0_INT_WIDTH;                                                          //[ 4: 4]
        jl_uint32 phy_1_int:CCS_CHIP_INT_OFFSET_PHY_1_INT_WIDTH;                                                          //[ 5: 5]
        jl_uint32 phy_2_int:CCS_CHIP_INT_OFFSET_PHY_2_INT_WIDTH;                                                          //[ 6: 6]
        jl_uint32 phy_3_int:CCS_CHIP_INT_OFFSET_PHY_3_INT_WIDTH;                                                          //[ 7: 7]
        jl_uint32 phy_4_int:CCS_CHIP_INT_OFFSET_PHY_4_INT_WIDTH;                                                          //[ 8: 8]
        jl_uint32 sds_0_int:CCS_CHIP_INT_OFFSET_SDS_0_INT_WIDTH;                                                          //[ 9: 9]
        jl_uint32 sds_1_int:CCS_CHIP_INT_OFFSET_SDS_1_INT_WIDTH;                                                          //[10:10]
        jl_uint32 rsvd0:CCS_CHIP_INT_OFFSET_RSVD0_WIDTH;                                                                  //[31:11]
    } BF;
...
#define CCS_INT_STATUS_OFFSET_USER_DEF_INT_6                                                                       (31)
#define CCS_INT_STATUS_OFFSET_USER_DEF_INT_6_WIDTH                                                                  (1)
typedef union CCS_INT_STATUS_u {
    struct __attribute__ ((packed)) {
        ...
        jl_uint32 user_def_int_6:CCS_INT_STATUS_OFFSET_USER_DEF_INT_6_WIDTH;                                              //[31:31]
    } BF;
...
#define CCS_INT_ENABLE_OFFSET_USER_DEF_INT_6_EN                                                                    (31)
#define CCS_INT_ENABLE_OFFSET_USER_DEF_INT_6_EN_WIDTH                                                               (1)
typedef union CCS_INT_ENABLE_u {
    struct __attribute__ ((packed)) {
        ...
        jl_uint32 user_def_int_6_en:CCS_INT_ENABLE_OFFSET_USER_DEF_INT_6_EN_WIDTH;                                        //[31:31]
    } BF;
...
#define CCS_INT_SET_OFFSET_USER_DEF_INT_6_SET                                                                      (31)
#define CCS_INT_SET_OFFSET_USER_DEF_INT_6_SET_WIDTH                                                                 (1)
typedef union CCS_INT_SET_u {
    struct __attribute__ ((packed)) {
        ...
        jl_uint32 user_def_int_6_set:CCS_INT_SET_OFFSET_USER_DEF_INT_6_SET_WIDTH;                                         //[31:31]
    } BF;
...
#define CCS_MODE_CFG_OFFSET_RSVD0                                                                                  (20)
#define CCS_MODE_CFG_OFFSET_RSVD0_WIDTH                                                                            (12)
...
#define CCS_MODE_CFG_OFFSET_TOP_DMA_BURST_UNLIMITED                                                                (18)
#define CCS_MODE_CFG_OFFSET_TOP_DMA_BURST_UNLIMITED_WIDTH                                                           (1)
#define CCS_MODE_CFG_OFFSET_OD_MODE_DISABLE                                                                        (19)
#define CCS_MODE_CFG_OFFSET_OD_MODE_DISABLE_WIDTH                                                                   (1)
typedef union CCS_MODE_CFG_u {
    struct __attribute__ ((packed)) {
        ...
        jl_uint32 top_dma_burst_unlimited:CCS_MODE_CFG_OFFSET_TOP_DMA_BURST_UNLIMITED_WIDTH;                              //[18:18]
        jl_uint32 od_mode_disable:CCS_MODE_CFG_OFFSET_OD_MODE_DISABLE_WIDTH;                                              //[19:19]
        jl_uint32 rsvd0:CCS_MODE_CFG_OFFSET_RSVD0_WIDTH;                                                                  //[31:20]
    } BF;
...
#define CCS_USER_DEF_INT_OFFSET_USER_DEF_INT_TRIG_6                                                                 (6)
#define CCS_USER_DEF_INT_OFFSET_USER_DEF_INT_TRIG_6_WIDTH                                                           (1)
typedef union CCS_USER_DEF_INT_u {
    struct __attribute__ ((packed)) {
        ...
        jl_uint32 user_def_int_trig_6:CCS_USER_DEF_INT_OFFSET_USER_DEF_INT_TRIG_6_WIDTH;                                  //[ 6: 6]
        jl_uint32 rsvd0:CCS_USER_DEF_INT_OFFSET_RSVD0_WIDTH;                                                              //[31: 7]
    } BF;
    jl_uint32 val[CCS_USER_DEF_INT_ENTRY_SIZE];
} CCS_USER_DEF_INT_t;

#define CCS_CCS_INT_CFG                                                                        ((jl_uint32)0x00201040U)
#define CCS_CCS_INT_CFG_NUM                                                                    ((jl_uint32)0x00000001U)
#define CCS_CCS_INT_CFG_ENTRY_SIZE                                                                                  (1)
#define CCS_CCS_INT_CFG_OFFSET_RSVD0                                                                                (2)
#define CCS_CCS_INT_CFG_OFFSET_RSVD0_WIDTH                                                                         (30)
#define CCS_CCS_INT_CFG_OFFSET_CCS_INT_POLARITY                                                                     (0)
#define CCS_CCS_INT_CFG_OFFSET_CCS_INT_POLARITY_WIDTH                                                               (1)
#define CCS_CCS_INT_CFG_OFFSET_CCS_PHY_INT_EN                                                                       (1)
#define CCS_CCS_INT_CFG_OFFSET_CCS_PHY_INT_EN_WIDTH                                                                 (1)
typedef union CCS_CCS_INT_CFG_u {
    struct __attribute__ ((packed)) {
        jl_uint32 ccs_int_polarity:CCS_CCS_INT_CFG_OFFSET_CCS_INT_POLARITY_WIDTH;                                         //[ 0: 0]
        jl_uint32 ccs_phy_int_en:CCS_CCS_INT_CFG_OFFSET_CCS_PHY_INT_EN_WIDTH;                                             //[ 1: 1]
        jl_uint32 rsvd0:CCS_CCS_INT_CFG_OFFSET_RSVD0_WIDTH;                                                               //[31: 2]
    } BF;
    jl_uint32 val[CCS_CCS_INT_CFG_ENTRY_SIZE];
} CCS_CCS_INT_CFG_t;
